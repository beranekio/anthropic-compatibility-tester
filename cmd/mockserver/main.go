...
// Standalone mock Anthropic-compatible server. Intended for testing gateways and
...
// http://<addr> (e.g. ANTHROPIC_BASE_URL=http://127.0.0.1:8080).
func main() {
	...
	go func() {
		log.Printf("mockserver listening on %s (base URL: http://%s)", *addr, listenHost(*addr))
